let clouds = ["I remember the summer I first met you, with your freckled smile and awkward hands tucked into the pocket of your hoodie",
  ...
  "what if we were slack",
  "what if we were precariously conformational",
  "what if you loved its thespian slyness",
  "an untapped question",
  "loving in convincingly supplanting ways",
  "an entangled question",
  ...
  "what if we were dirtier",
  "what if we were structurally wise",
  ...
  "what if we were monstrous",
  "what if we were sometime insoluble",
  "what if we were tiled",
  "an underpaid question",
  "what if we were intolerable",
  "a daft question",
  "what if we were rarer",
  ...
  "what if we were silky",
  "what if we met at the weary payer",
  "an irreplaceable question",
  "what if we were alarming",
  "what if we were instructive",
  "loving in incredibly belying ways",
  "what if we were rhetorical",
  "what if I loved its certain mood",
  "what if we were rainier",
  "what if we were neurotic",
  "a nonfat question",
  "loving in foolishly appeasing ways",
  "what if we were invasive",
  "loving in impassively nauseating ways",
  "what if we were the biggest",
  "what if we were sillier",
  "what if we were primarily artful",
